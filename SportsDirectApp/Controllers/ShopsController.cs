...
namespace SportsDirectApp.Controllers
{
    ...
    public class ShopsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Url,Description")] Shop shop)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var shop = await _context.Shop.SingleOrDefaultAsync(m => m.Id == id);
            if (shop == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Url,Description")] Shop shop)
        {
            if (id != shop.Id)
            {
                return NotFound();
